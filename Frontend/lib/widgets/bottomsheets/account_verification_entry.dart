...
import 'package:Classy/widgets/buttons/custom_outline_button.dart';
    ...
    return BasePage(
      ...
      body: VStack(
        [
          ...
          // ).centered(),
          //
          "Verify Phone Number".tr().text.bold.xl.make(),
          ("Enter the 4 digit code we've sent to you on mobile number".tr() +
                  " ${widget.phone}")
              .text
              .gray600
              .sm
