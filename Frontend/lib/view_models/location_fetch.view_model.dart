...
import 'package:Classy/services/permission.service.dart';
...
import 'package:Classy/utils/map.utils.dart';
...
class LocationFetchViewModel extends MyBaseViewModel {
  ...
  void initialise() async {
    // Ensure Google Maps JS SDK is loaded for web before any place picker
    MapUtils.ensureWebMapsLoaded();
    try {
