...
const menuItems: MenuItem[] = [
  ...
  { name: 'Restaurants Pending', href: '/restaurants-requested', icon: Building2 },
  { name: 'Restaurants Docs Updated', href: '/restaurants-docs-updated', icon: FileCheck },
  { name: 'Vendors', href: '/vendors', icon: Building2 },
  { name: 'Vendors Pending', href: '/vendors-requested', icon: Building2 },
  { name: 'Drivers', href: '/drivers', icon: Car },
  { name: 'Drivers Pending', href: '/drivers-requested', icon: Car },
  ...
  { name: 'Cashbook System', href: '/cashbook', icon: Calculator },
...
const operationsItems: MenuItem[] = [
  ...
  { name: 'Enhanced Live Tracking', href: '/enhanced-live-tracking', icon: MapPin },
