...
import CashbookSystem from './components/CashbookSystem'
  ...
  return (
    <Routes>
      ...
      <Route path="/" element={
        ...
        <Route path="enhanced-live-tracking" element={<EnhancedLiveTracking />} />
        <Route path="incident-management" element={<IncidentManagement />} />
        <Route path="analytics" element={<Analytics />} />
        <Route path="helpdesk" element={<Helpdesk />} />
        <Route path="cashbook" element={<CashbookSystem />} />
