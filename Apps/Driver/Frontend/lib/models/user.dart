...
class User {
  ...
  factory User.fromJson(Map<String, dynamic> json) => User(
        ...
        rating: (json['rating'] != null) ? (json['rating'].toString().toDouble() ?? 5.00) : 5.00,
        isOnline: (json['is_online'] != null) ? (json['is_online'].toString().toInt() ?? 0) == 1 : false,
        isTaxiDriver: (json['is_taxi_driver'] != null) ? (json['is_taxi_driver'] is bool
            ? json['is_taxi_driver']
            : (json['is_taxi_driver'].toString().toInt() ?? 0) == 1) : false,
