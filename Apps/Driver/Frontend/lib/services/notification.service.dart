...
class NotificationService {
  ...
  static Future<void> onActionReceivedMethod(
    ...
    if (receivedAction.payload != null &&
      ...
      FirebaseService.instance.saveNewNotification(
        null,
        title: receivedAction.title,
        body: receivedAction.body,
      );
      FirebaseService.instance.notificationPayloadData = receivedAction.payload;
  ...
  static Stream<int> get unreadCountStream {
    // Return a simple stream that emits 0 for now
    // This can be enhanced to actually track unread notifications
