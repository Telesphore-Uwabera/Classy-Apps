...
class FirebaseDataService {
  ...
  Stream<List<NotificationModel>> getUserNotificationsStream(String userId, {int limit = 50}) {
    return _firestore
  ...
  Future<List<Map<String, dynamic>>> searchServices(String query, {String? category, int limit = 20}) async {
    try {
      ...
      final services = snapshot.docs.map((doc) => doc.data() as Map<String, dynamic>).toList();
