...
import 'views/pages/profile/account_delete.page.dart';
import 'views/pages/profile/printer_settings.page.dart';
...
class ProfileViewModel extends MyBaseViewModel {
  ...
  changeLanguage() async {
    // Language selection removed - app uses English only
