...
import 'package:fuodz/view_models/create_account.view_model.dart';
...
class _CreateAccountPageState extends State<CreateAccountPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return ViewModelBuilder<CreateAccountViewModel>.reactive(
      viewModelBuilder: () => CreateAccountViewModel(context),
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      "Join as a vendor and start earning",
                      style: TextStyle(
                        fontSize: 16,
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              CountryPicker(
                                selectedCountry: vm.selectedCountry ?? Country.defaultCountry,
                                onCountryChanged: (country) {
                                  vm.updateSelectedCountry(country);
                                },
                                showFlag: true,
                                showName: false,
                                showPhoneCode: true,
                        ...
                        FormBuilderTextField(
                          ...
                          decoration: inputDec.copyWith(
                            ...
                            prefixIcon: Icon(Icons.email, color: const Color(0xFFE91E63)),
                          ),
                        ),
                        const SizedBox(height: 16),
                        ...
                        FormBuilderTextField(
                          ...
                          decoration: inputDec.copyWith(
                            ...
                            prefixIcon: Icon(Icons.lock_outline, color: const Color(0xFFE91E63)),
                          ),
                        ),
                        const SizedBox(height: 16),
                        ...
                        FormBuilderTextField(
                          ...
                          decoration: inputDec.copyWith(
                            ...
                            prefixIcon: Icon(Icons.business, color: const Color(0xFFE91E63)),
                          ),
                        ),
                        const SizedBox(height: 16),
                        ...
                        FormBuilderTextField(
                          ...
                          decoration: inputDec.copyWith(
                            ...
                            prefixIcon: Icon(Icons.description, color: const Color(0xFFE91E63)),
                          ),
                        ),
                        const SizedBox(height: 16),
