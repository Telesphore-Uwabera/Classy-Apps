...
// import 'firebase_token.service.dart'; // File not found
...
class FirebaseService {
  ...
  setUpFirebaseMessaging() async {
    ...
    // FirebaseTokenService().handleDeviceTokenSync(); // Service not available
        ...
        //vendor type of notification
          ...
          try {
            ...
            if (vendorId != null) {
              ...
              try {
                // vendor = await VendorRequest().vendorDetails(vendorId); // Method doesn't exist
                AlertService.loading();
              } catch (error) {
                AlertService.loading();
              }
        ...
        //product type of notification
          ...
          try {
            ...
            if (productId != null) {
              AlertService.loading();
              try {
                product = await ProductRequest().getProductDetails(productId);
                AlertService.loading();
              } catch (error) {
                AlertService.loading();
              }
