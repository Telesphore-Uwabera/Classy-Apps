...
class Utils {
  static bool get isArabic {
    ...
    if (translator.activeLocale == null || translator.activeLocale.languageCode == null) {
      return false; // Default to false if locale is not available
    }
  ...
  static setJiffyLocale() async {
    // Add null safety check for translator.activeLocale
    if (translator.activeLocale == null) {
      await Jiffy.setLocale("en");
      return;
    }
    
    String cLocale = translator.activeLocale.languageCode ?? "en";
