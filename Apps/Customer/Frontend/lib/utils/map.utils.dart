...
// Conditional import for web script injector
import 'package:Classy/web/gmap_loader_stub.dart'
    if (dart.library.html) 'package:Classy/web/gmap_loader_web.dart';
...
class MapUtils {
  //
  static void ensureWebMapsLoaded() {
    if (kIsWeb) {
      final key = AppStrings.googleMapApiKey;
      if (key.isNotEmpty) {
        loadGoogleMapsJs(key);
      }
    }
  }
