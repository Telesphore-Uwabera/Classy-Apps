...
import 'package:Classy/view_models/wallet.vm.dart';
...
import 'package:Classy/widgets/list_items/wallet_transaction.list_item.dart';
                ...
                [
                  ...
                  Align(
                    ...
                    child: TextButton.icon(
                      onPressed: () => Navigator.of(context).pushNamed('payment_methods'),
                      icon: const Icon(Icons.credit_card_outlined),
                      label: Text('Payment Methods'.tr()),
                    ).pOnly(right: 8),
                  ),
