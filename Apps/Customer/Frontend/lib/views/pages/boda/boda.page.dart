...
import '../taxi/driver_connection.page.dart';
import '../taxi/driver_search.page.dart';

class BodaPage extends StatefulWidget {
  const BodaPage(this.vendorType, {Key? key}) : super(key: key);

  final VendorType vendorType;

  @override
  _BodaPageState createState() => _BodaPageState();
}

class _BodaPageState extends State<BodaPage> {
  @override
    ...
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => DriverSearchPage(
          ...
          vehicleTypeId: 2, // Boda boda vehicle type
        ),
      ),
    );
  }
