...
class _PaymentMethodsPageState extends State<PaymentMethodsPage> {
  ...
  Future<void> _loadPaymentMethods() async {
    ...
    try {
      final response = await _paymentApiService.getPaymentAccounts();
  ...
  Future<void> _updatePaymentMethod(Map<String, dynamic> paymentMethod, String name, String number, String instructions) async {
    try {
      final response = await _paymentApiService.updatePaymentAccount(
  ...
  Future<void> _confirmDeletePaymentMethod(Map<String, dynamic> paymentMethod) async {
    try {
      final response = await _paymentApiService.deletePaymentAccount(paymentMethod['id'].toString());
