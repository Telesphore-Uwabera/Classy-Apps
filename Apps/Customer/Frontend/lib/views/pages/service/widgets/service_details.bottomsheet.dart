...
import 'package:Classy/constants/app_text_styles.dart';
import 'package:Classy/view_models/service_details.vm.dart';
...
class ServiceDetailsBottomSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return VStack([
          ...
          Visibility(visible: !vm.service.isFixed, child: 2.heightBox),

          //
          CustomButton(
            title: "Continue".tr(),
            titleStyle: AppTextStyle.h4TitleTextStyle(color: Colors.white),
